...
public class Shooter {
  ...
  // This code was taken from TalonFX, so some of it I do not understand

  // This is the code for our shooter. It had a duel flywheel, so to make the code easier, the right shooter
  // was programmed to "follow" the other shooter. 

  TalonFX falconShooterLeftLeader, falconShooterRightFollower;
  //I believe this limits the voltage to break the motor
  ...
  Shooter(int leftCANID, int rightCANID) {
     ...
     */
    // configs.Slot1.kP = 5; // An error of 1 rotation per second results in 5 amps
    // output
    // configs.Slot1.kI = 0.1; // An error of 1 rotation per second increases output
    // by 0.1 amps every second
